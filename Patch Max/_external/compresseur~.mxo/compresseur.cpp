...
name: "compresseur", "compressor"
version: "0.0"
Code generated with Faust 2.40.7 (https://faust.grame.fr)
Compilation options: -a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn compresseur -es 1 -mcd 16 -uim -double -ftz 0
------------------------------------------------------------ */

#ifndef  __compresseur_H__
#define  __compresseur_H__
...
class compresseur : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("analyzers_lib_version", "0.1");
		m->declare("author", "JOS, revised by RM");
		m->declare("basics_lib_bypass2_author", "Julius Smith");
		m->declare("basics_lib_name", "Faust Basic Element Library");
		m->declare("basics_lib_version", "0.6");
		m->declare("compilation_options", "-single -scal -I libraries/ -I project/ -lang wasm");
		m->declare("compile_options", "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn compresseur -es 1 -mcd 16 -uim -double -ftz 0");
		...
		m->declare("compressors_lib_compressor_stereo_author", "Julius O. Smith III");
		m->declare("compressors_lib_compressor_stereo_copyright", "Copyright (C) 2014-2020 by Julius O. Smith III <jos@ccrma.stanford.edu>");
		m->declare("compressors_lib_compressor_stereo_license", "MIT-style STK-4.3 license");
		m->declare("compressors_lib_name", "Faust Compressor Effect Library");
		m->declare("compressors_lib_version", "0.2");
		...
		m->declare("library_path3", "/libraries/compressors.lib");
		m->declare("library_path4", "/libraries/maths.lib");
		m->declare("library_path5", "/libraries/platform.lib");
		m->declare("library_path6", "/libraries/analyzers.lib");
		m->declare("library_path7", "/libraries/signals.lib");
		m->declare("library_path8", "/libraries/routes.lib");
	...
	virtual compresseur* clone() {
		return new compresseur();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalBargraph("Compressor Gain", &fHbargraph0, FAUSTFLOAT(-50.0), FAUSTFLOAT(10.0));
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Ratio", &fHslider1, FAUSTFLOAT(5.0), FAUSTFLOAT(1.0), FAUSTFLOAT(20.0), FAUSTFLOAT(0.10000000000000001));
		...
		ui_interface->addHorizontalSlider("Threshold", &fHslider4, FAUSTFLOAT(-30.0), FAUSTFLOAT(-100.0), FAUSTFLOAT(10.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider2, FAUSTFLOAT(50.0), FAUSTFLOAT(1.0), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.10000000000000001));
		...
		ui_interface->addHorizontalSlider("Release", &fHslider3, FAUSTFLOAT(500.0), FAUSTFLOAT(1.0), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addHorizontalSlider("Makeup Gain", &fHslider0, FAUSTFLOAT(40.0), FAUSTFLOAT(-96.0), FAUSTFLOAT(96.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow1 = std::pow(10.0, 0.050000000000000003 * double(fHslider0));
		double fSlow2 = 1.0 / std::max<double>(1.1920928960000001e-07, double(fHslider1)) + -1.0;
		double fSlow3 = std::max<double>(fConst0, 0.001 * double(fHslider2));
		int iSlow4 = std::fabs(fSlow3) < 1.1920928960000001e-07;
		double fThen3 = std::exp(0.0 - fConst0 / ((iSlow4) ? 1.0 : fSlow3));
		double fSlow5 = ((iSlow4) ? 0.0 : fThen3);
		double fSlow6 = std::max<double>(fConst0, 0.001 * double(fHslider3));
		int iSlow7 = std::fabs(fSlow6) < 1.1920928960000001e-07;
		double fThen5 = std::exp(0.0 - fConst0 / ((iSlow7) ? 1.0 : fSlow6));
		double fSlow8 = ((iSlow7) ? 0.0 : fThen5);
		double fSlow9 = double(fHslider4);
		double fSlow10 = 0.5 * fSlow3;
		int iSlow11 = std::fabs(fSlow10) < 1.1920928960000001e-07;
		double fThen8 = std::exp(0.0 - fConst0 / ((iSlow11) ? 1.0 : fSlow10));
		double fSlow12 = ((iSlow11) ? 0.0 : fThen8);
		double fSlow13 = 1.0 - fSlow12;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			double fTemp0 = double(input0[i0]);
			double fTemp1 = ((iSlow0) ? 0.0 : fTemp0);
			double fTemp2 = double(input1[i0]);
			double fTemp3 = ((iSlow0) ? 0.0 : fTemp2);
			double fTemp4 = std::fabs(std::fabs(fTemp3) + std::fabs(fTemp1));
			double fTemp5 = ((fRec1[1] > fTemp4) ? fSlow8 : fSlow5);
			fRec2[0] = fTemp4 * (1.0 - fTemp5) + fTemp5 * fRec2[1];
			fRec1[0] = fRec2[0];
			fRec0[0] = fSlow2 * std::max<double>(20.0 * std::log10(std::max<double>(1.175494351e-38, fRec1[0])) - fSlow9, 0.0) * fSlow13 + fSlow12 * fRec0[1];
			double fTemp6 = std::pow(10.0, 0.050000000000000003 * fRec0[0]);
			double fTemp7 = fTemp1 * fTemp6;
			double fThen9 = fSlow1 * fTemp7;
			output0[i0] = FAUSTFLOAT(((iSlow0) ? fTemp0 : fThen9));
			double fTemp8 = fTemp3 * fTemp6;
			double fTemp9 = std::fabs(std::fabs(fTemp7) + std::fabs(fTemp8));
			double fTemp10 = ((fRec4[1] > fTemp9) ? fSlow8 : fSlow5);
			fRec5[0] = fTemp9 * (1.0 - fTemp10) + fTemp10 * fRec5[1];
			fRec4[0] = fRec5[0];
			fRec3[0] = fSlow2 * std::max<double>(20.0 * std::log10(std::max<double>(1.175494351e-38, fRec4[0])) - fSlow9, 0.0) * fSlow13 + fSlow12 * fRec3[1];
			fHbargraph0 = FAUSTFLOAT(20.0 * std::log10(std::max<double>(1.175494351e-38, std::pow(10.0, 0.050000000000000003 * fRec3[0]))));
			double fThen11 = fSlow1 * fTemp8;
			output1[i0] = FAUSTFLOAT(((iSlow0) ? fTemp2 : fThen11));
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
			fRec5[1] = fRec5[0];
	...
	#define FAUST_FILE_NAME "compresseur.dsp"
	#define FAUST_CLASS_NAME "compresseur"
	#define FAUST_COMPILATION_OPIONS "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn compresseur -es 1 -mcd 16 -uim -double -ftz 0"
	#define FAUST_INPUTS 2
	#define FAUST_OUTPUTS 2
	#define FAUST_ACTIVES 6
	#define FAUST_PASSIVES 1

	FAUST_ADDCHECKBOX("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[0]/Bypass", fCheckbox0);
	FAUST_ADDHORIZONTALBARGRAPH("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[0]/Compressor Gain", fHbargraph0, -50.0, 10.0);
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[3] Compression Control/Ratio", fHslider1, 5.0, 1.0, 20.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[3] Compression Control/Threshold", fHslider4, -30.0, -100.0, 10.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Attack", fHslider2, 50.0, 1.0, 1000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Release", fHslider3, 500.0, 1.0, 1000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/Makeup Gain", fHslider0, 40.0, -96.0, 96.0, 0.10000000000000001);

	#define FAUST_LIST_ACTIVES(p) \
		p(CHECKBOX, Bypass, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[0]/Bypass", fCheckbox0, 0.0, 0.0, 1.0, 1.0) \
		p(HORIZONTALSLIDER, Ratio, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[3] Compression Control/Ratio", fHslider1, 5.0, 1.0, 20.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Threshold, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[3] Compression Control/Threshold", fHslider4, -30.0, -100.0, 10.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Attack, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Attack", fHslider2, 50.0, 1.0, 1000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Release, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Release", fHslider3, 500.0, 1.0, 1000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Makeup_Gain, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/Makeup Gain", fHslider0, 40.0, -96.0, 96.0, 0.10000000000000001) \

	#define FAUST_LIST_PASSIVES(p) \
		p(HORIZONTALBARGRAPH, Compressor_Gain, "COMPRESSOR [tooltip: Reference:         http://en.wikipedia.org/wiki/Dynamic_range_compression]/[0]/Compressor Gain", fHbargraph0, 0.0, -50.0, 10.0, 0.0) \
 ...
 */
class compresseur_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<compresseur_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: compresseur_poly will use and finally delete the pointer.
        ...
        virtual compresseur_poly* clone()
        {
            return new compresseur_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    {
        dsp_poly* dsp_poly = new compresseur_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    if (nvoices > 0) {
    ...
    #endif
        x->m_dsp = new compresseur_poly(new compresseur(), nvoices, true, true);
    #ifdef POLY2
        ...
        x->m_dsp = createSRAdapter<FAUSTFLOAT>(new compresseur(), DOWN_SAMPLING, UP_SAMPLING, FILTER_TYPE);
    }
...
void* faust_new(t_symbol* s, short ac, t_atom* av)
{
    ...
    compresseur* tmp_dsp = new compresseur();
